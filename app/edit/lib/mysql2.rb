...
require './lib/mysql2/version' unless defined? Mysql2::VERSION
require './lib/mysql2/error'
#require './lib/mysql2/mysql2'
require './lib/mysql2/result'
require './lib/mysql2/client'
require './lib/mysql2/field'
require './lib/mysql2/statement'
